...
\title{DSV-Bibliotheksentwicklung angewandt als digitaler Synthesizer}
...
\begindate{01. Juni 2026} % Beginn
\duedate{08. September 2026} % Abgabe
...
\begin{itemize}
    \item ChatGPT, Github und Claude zur Hilfe der Formulierung.
    \item ChatGPT und Claude Literaturrecherche.
    \item Copilot während der Arbeit am Code als integriertes Werkzeug in der IDE.
    \item ChatGPT für Verständnis Fragen.
    \item Claude zur Fehlersuche in dieser Arbeit.
\end{itemize}
...
\begin{acknowledgements}
  Vielen Dank an Dr. J. Witulski für die Betreuung der Arbeit.\\
  Vielen Dank an Robert für die die Hilfe bei dem Gehäuse.\\
  Vielen Dank an Luca, Flo und Leonie für die Motivation beim Schreiben.\\
  Vielen Dank an meine Eltern für das Korrekturlesen. 
