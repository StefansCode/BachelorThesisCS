...
sehr gutes Vorbild. Java Streams setzen als Fluent API die Mentalität 
...
Abarbeitung dargestellt und gezeigt wie eine Anwendung der Signalklasse aussehen
könnte.
...
Neben der Signalklasse soll es außerdem eine Soundklasse geben, welche 
die Signalklasse auf ein Audiosignal spezifiziert. Der größte Unterschied 
zwischen diesen liegt darin, dass ein Soundobjekt das Signal selber erzeugt
und einem Signalobjekt ein Signal übergeben wird.
