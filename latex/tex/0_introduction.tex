...
zwischen diesen liegt darin, dass die Audiobibliothek das Signal selber erzeugt
...
Espressif Systems entwickelt wurde. Sie ist auf die Nutzung der Hardware des ESP32 
optimiert und erwartet Signale in der Form eines Arrays. Der Vorteil der 
zu entwickelnden DSV-Bibliothek ist, dass ein Signal als eine Fluent API
...
\cite{MozziSimpleSketch}. Mit der zu entwickelnde Audiobibliothek werden 
