...
Die Klasse ist eien FluentAPi\cite{fluentAPI}. Das bedeutet, dass die 
nicht beendende Funktionen eine Referenz auf das Signalobjekt zurückgeben. Dadurch können
Methodeaufrufe verkettet werden, um komplexe Operationen auf das Signal anzuwenden.
...
Da viele Funktionen, wie zum Beispiel, lohnt es sich diese auch zu speichen.
...
wichtig, da hie Speicher und rechenkapazität begrenzt sind. Ein Ringbuffer hat außerdem 
...
Funktionenin die Verarbeitungskette einzufügen.
...
Die Abtastrate hängt davon ab, wie oft in der Sekunde eine Inputfunktionen
augerufen wird.
