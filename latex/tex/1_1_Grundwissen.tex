...
$f: 1/n\mathbb{Z} \rightarrow 1/m\mathbb{Z}$ mit $n,m \in \mathbb{N}$. 
...
als 
$$f = 1/\min\{\delta > 0 | f(x+\delta)=f(x) \forall x \in R\}$$ definiert.
...
der Y-Achse.
Für $f_d$ mit Minimalwert -1 und Maximalwert 1
wäre das 11.
