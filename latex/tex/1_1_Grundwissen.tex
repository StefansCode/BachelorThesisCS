...
Jedes stückweise stetige periodische Signal $S$ lässt sich, mit Hilfe der Fouriereihe,
...
Das \textbf{Abtatsttheorem} \cite{grueningen2008dsv} besagt, dass das 
Signale $S$ wieder aus seiner Darstellung als digitales Signal $S_d$ 
...
\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption{Beispiel einses Systems}
\end{figure}
...
kann von einem DAC (Digital-zu-Analog-Konverter) erzeut werden, 
...
TODO Schreibe das später

Nun ist also die Frage, was für ein Signal der DAC erwartet. Da gibt es viele
verschiedene Möglichkeiten. Aber ein Standard für digitale Audio ist 
I2S (Inter-IC Sound). Das ist ein Protokoll, welches Stereoaudio, also 2 
Audiosignale, über 3 (manchmal 4) Leitungen überträgt.
\begin{enumerate}
    \item BCLK (Bit-Clock) ist der Taktgeber.
    \item LRCLK (Left-Right-Clock) gibt an, ob gerade Links oder Rechts übertragen
     wird.
    \item DIN/DOUT (Data in/ Data out) übertragt die Audiodaten.
\end{enumerate}
...
(PCM)\cite{jita2023} Daten ist ein unkomprimiertes 
Audioformat mit meistens 8, 16, 24 oder 32 Bit unsigned Integern. 


Das menschliche Gehöhr kann in der Regel Frequezen zwischen 20 und 20000
Hertz wahrnehmen. Aus dem Abtatsttheorem folgt, das einen Abtastrate von 
mindestens 40000Hz nötig ist um Ton digital darzustellen.
