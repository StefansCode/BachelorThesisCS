...
\begin{figure}[H]
    \begin{center}
        ...
        \caption{Fusion360 mit der Hülle und dem geladenem Bild der Platine.}%
        \label{fig:fusion360}
    \end{center}
...
geschickt, der die Hülle Schicht für Schicht druckt.

\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{fig/case/3D_Drucker.jpeg}
        \caption{Der 2D Drucker Bambu Lab P1S}%
        \label{fig:drucker}
    \end{center}
...
der Hülle zu finden. STEP-Dateien sind Dateien die von CAD-Programmen wie 
Fusion geladen werden können. TODO link zu github und sagen warum step 
gut ist.
...
um 2 Löcher zu boren, durch die 2 Säulen laufen. Die Mittelpunkte der Löcher
liegen genau auf den kleinen Löchern der 
