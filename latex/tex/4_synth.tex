...
Die Wellenform wird als Ganzzahl gespeichet und in durch if-Abfragen wird 
...
Der Ausgabewert wird gespeichertundkann über die Methode \lstinline{getValue()}
abgerufen werden. Das speichern ist lesen ist Threadsafe, sodass die Hüllkurve 
...
unabhängig voneinander gespielt werden können. wird ein Knopf während
losgelassen und während der Release-Phase erneut gedrückt, startet die 
...
können wie in Abbildung \ref{fig:menu_tree} dargestellt, werden. Es git aßerdem
...
rechten Seite des Bildschirms. Mit dem Drehgeber kann ein Wert des Paramater 
den das Blat representiert gewählt werden. Der Wert wird mit dem A-Knopf 
